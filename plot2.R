#plot2.R:
#This R-script creates a line plot of Global Active Power v/s weekdays.....over a period of 
...
# line plot on-screen and make sure it looks ok
plot(df$posixDate, df$Global_active_power, type= "l", ylab= "Global Active Power (kilowatts)", xlab="")
# copy to device
